...
public class WriteLock extends ProtocolSupport {
            ...
            do {
                ...
                if (names.isEmpty()) {
                    ...
                    if (!lessThanMe.isEmpty()) {
                        ...
                        Stat stat = zookeeper.exists(lastChildId, watch ? new LockWatcher() : null);
                        if (stat != null) {
    ...
    private boolean doLock(boolean watch) throws KeeperException, InterruptedException {
        if (isClosed()) {
            return false;
        }
        ensurePathExists(dir);

        LockZooKeeperOperation zop = new LockZooKeeperOperation();
        zop.watch(watch);
